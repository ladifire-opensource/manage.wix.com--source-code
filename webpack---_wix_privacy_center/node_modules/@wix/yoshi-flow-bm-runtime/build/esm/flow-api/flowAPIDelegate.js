...
var FlowAPIDelegate = /** @class */ (function () {
    ...
    FlowAPIDelegate.prototype.createFedopsLogger = function (appName) {
        var _a;
        var _b = this, bmModule = _b.bmModule, module = _b.module;
        return bmModule._essentials.createFedopsLogger(appName, __assign({}, (_a = module.config.fedops) === null || _a === void 0 ? void 0 : _a.config));
    };
    ...
    FlowAPIDelegate.prototype.createBMMethodFlowAPI = function (method) {
        ...
        var fedopsLogger = this.createFedopsLogger(method.methodId);
        return {
            get module() {
            ...
            get errorMonitor() {
                var _a, _b;
                assertErrorMonitorEnabledApi(moduleFlowAPI.errorMonitor, (_b = (_a = module.config) === null || _a === void 0 ? void 0 : _a.sentry) === null || _b === void 0 ? void 0 : _b.errorMonitor, 'sentry.errorMonitor');
                return moduleFlowAPI.errorMonitor;
            },
            get moduleParams() {
    ...
    FlowAPIDelegate.prototype.getComponentHooksFlowAPI = function (component, _a) {
        var _this = this;
        var fedopsLogger = _a.fedopsLogger, maybeComponentTranslationsAPI = _a.maybeComponentTranslationsAPI, ownProps = _a.ownProps;
        var _b = this, moduleFlowAPI = _b.moduleFlowAPI, module = _b.module;
    ...
    FlowAPIDelegate.prototype.createBMComponentAPI = function (component, _a) {
        var fedopsLogger = _a.fedopsLogger, componentTranslationsAPI = _a.componentTranslationsAPI;
        return __awaiter(this, void 0, void 0, function () {
            var _b, moduleFlowAPI, flowAPIInstances, module, maybeTranslations, maybeExperiments, getBILogger, maybeBILogger, translationsAPI;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = this, moduleFlowAPI = _b.moduleFlowAPI, flowAPIInstances = _b.flowAPIInstances, module = _b.module;
