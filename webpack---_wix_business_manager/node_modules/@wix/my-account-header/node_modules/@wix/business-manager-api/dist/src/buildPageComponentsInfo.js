...
exports.buildPageComponentsInfo = void 0;
...
function buildPageComponentsInfo(experiments, isDebug) {
    ...
    var membersPermissionsPageComponent = {
        route: 'member-permissions',
        isMain: true,
        isEnabled: true,
        pageComponentId: PageComponentId_1.PageComponentId.MemberPermissions,
        pageComponentName: 'member-permissions',
        moduleId: ModuleId_1.ModuleId.MemberPermissions,
        appDefId: appDefIds_1.appDefIds.wixSiteMembers
    };
    var pages = (_a = {},
        ...
        _a[PageComponentId_1.PageComponentId.MemberPermissions] = membersPermissionsPageComponent,
        _a);
    if (wixExperiments.enabled('specs.wos.DeprecateBuildPageComponentsInfo')) {
        return pages;
    }
    return tslib_1.__assign(tslib_1.__assign({}, pages), (_b = {}, _b[PageComponentId_1.PageComponentId.Home] = homePageComponent, _b[PageComponentId_1.PageComponentId.Settings] = settingsPageComponent, _b[PageComponentId_1.PageComponentId.Engage] = engagePageComponent, _b));
}
