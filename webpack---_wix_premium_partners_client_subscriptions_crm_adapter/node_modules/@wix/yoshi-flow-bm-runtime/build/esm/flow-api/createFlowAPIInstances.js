...
export function createFlowAPIInstances(_a) {
    ...
    var _h = module.config, translationsConfig = _h.translations, sentryConfig = _h.sentry, maybeTranslationsModel = module.maybeTranslationsModel;
    ...
    if (maybeTranslationsModel) {
        ...
        var _j = createFetchAsyncMessagesLoader({
        ...
        }), asyncMessagesLoader = _j.asyncMessagesLoader, addLocaleMessages = _j.addLocaleMessages;
        var i18n_1 = bmModule._essentials.createI18n({
            asyncMessagesLoader: asyncMessagesLoader,
            useSuspense: (_d = translationsConfig === null || translationsConfig === void 0 ? void 0 : translationsConfig.suspense) !== null && _d !== void 0 ? _d : true,
    ...
    return {
        ...
        maybeExperiments: ((_e = module.config.experiments) === null || _e === void 0 ? void 0 : _e.centralized) ? makeMutable(bmModule._essentials.experiments)
            : ((_g = (_f = module.config.experiments) === null || _f === void 0 ? void 0 : _f.scopes) === null || _g === void 0 ? void 0 : _g.length) ? bmModule._essentials.createExperiments({ scopes: [] })
                : undefined,
    };
}
