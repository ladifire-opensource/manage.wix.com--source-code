...
export function dsl(_a) {
    var _b;
    var fileName = _a.fileName, functionName = _a.functionName;
    var base;
    ...
    if (process.env.EXPERIMENTAL_YOSHI_SERVERLESS_HASH) {
        ...
        if (process.env.NODE_ENV === 'test') {
            ...
            base = '/serverless-yoshi-dash-suggestions-app/dashboard-suggestions-app-6e1a944e0a2ae9d429f66d5222f88915';
        }
    }
    else {
