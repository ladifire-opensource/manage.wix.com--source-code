        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (localeDistPath == null || !availableLocales.has(locale)) {
                        return [2 /*return*/, Promise.reject(new Error("Locale assets for " + locale + " are not provided"))];
                    }
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4: return [2 /*return*/, Promise.reject(new Error("Can't fetch locale " + locale + ", status code: " + status_1))];
                case 5:
                    e_2 = _a.sent();
                    if (errorReporter) {
                        if (isErrorMonitorEnabled(errorReporter)) {
                    ...
                    return [2 /*return*/, Promise.reject(new Error("Can't fetch locale " + locale + " due to fetch error"))];
