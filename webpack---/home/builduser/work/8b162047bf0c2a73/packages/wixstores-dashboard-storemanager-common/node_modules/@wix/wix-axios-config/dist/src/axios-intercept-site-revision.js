...
exports.siteRevisionHeader = exports["default"] = void 0;
  ...
  var requestSuccess = function requestSuccess(config) {
    ...
    if (shouldAddSiteRevision) {
      ...
      if (siteRevision) {
        ...
        var headers = _objectSpread(_objectSpread({}, config.headers), {}, (_objectSpread2 = {}, _objectSpread2[siteRevisionHeader] = siteRevision, _objectSpread2));
...
var getSiteRevision = function getSiteRevision(wixCodeApi) {
  ...
  var siteRevisionFromQueryParam = getSiteRevisionFromQueryParam();
...
var getSiteRevisionFromQueryParam = function getSiteRevisionFromQueryParam() {
  if (typeof window !== 'undefined' && window.location) {
    return (0, _urlUtils.extractQueryParam)(window.location, 'siteRevision');
  }
};
...
exports.siteRevisionHeader = siteRevisionHeader;