...
export default function wrapComponent(Component, module, flowAPI) {
    ...
    return (props) => {
        var _a;
        const { routeBaseName, router, metaSiteId, children, config, accountLanguage, brand, coBranding, debug, instanceId, liveSite, locale, primarySiteLocale, siteName, userId, userPermissions, userRole, viewMode } = props, restProps = __rest(props, ["routeBaseName", "router", "metaSiteId", "children", "config", "accountLanguage", "brand", "coBranding", "debug", "instanceId", "liveSite", "locale", "primarySiteLocale", "siteName", "userId", "userPermissions", "userRole", "viewMode"]);
