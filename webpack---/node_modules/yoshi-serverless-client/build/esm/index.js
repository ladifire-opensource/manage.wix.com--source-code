...
var default_1 = /** @class */ (function () {
    function default_1(_a) {
        var _b = _a === void 0 ? {} : _a, baseUrl = _b.baseUrl, isSSR = _b.isSSR;
        var wixBase = isSSR ||
    ...
    default_1.prototype.request = function (method, options) {
        ...
        return function () {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var fileName, functionName, body, url, _fetch, res, error, error, errorMessage, result;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            url = joinUrls(this.baseUrl, "/_api_/" + fileName);
                            _fetch = (typeof self !== 'undefined' && self.fetch) || fetch;
                            return [4 /*yield*/, _fetch(url, {
