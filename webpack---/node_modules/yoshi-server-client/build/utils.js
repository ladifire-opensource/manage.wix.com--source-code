...
exports.showToast = exports.joinUrls = void 0;
...
function showToast(error, method, args, baseUrl) {
            ...
            Toastify({
                ...
                onClick: function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var _a, file, line, col;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = error.errors[0].stack.match(/\/([/\w-_.]+\.[j|t]sx?):(\d*):(\d*)/), file = _a[1], line = _a[2], col = _a[3];
                                    return [4 /*yield*/, fetch(baseUrl + ("/_launchEditor_?file=" + file + "&line=" + line + "&col=" + col), {
