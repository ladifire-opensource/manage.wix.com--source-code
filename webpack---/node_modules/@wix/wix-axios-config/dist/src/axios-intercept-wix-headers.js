...
var _headers = require("@wix/headers");
...
function getInterceptor(_ref) {
  ...
  var requestSuccess = function requestSuccess(config) {
    ...
    var wixHeaders = shouldAddWixHeaders ? (0, _headers.createHeaders)({
      csrf: false,
...
function signedInstanceAllowed(signedInstance, _ref2) {
  ...
  return signedInstance && (0, _urlUtils.isReqToOriginDomain)(url, baseURL) ? signedInstance : '';
}
