...
export function createFlowAPIInstances(_a) {
    ...
    var _f = module.config, translationsConfig = _f.translations, sentryConfig = _f.sentry, maybeTranslationsModel = module.maybeTranslationsModel;
    var maybeSentry = (sentryConfig === null || sentryConfig === void 0 ? void 0 : sentryConfig.DSN) && !(sentryConfig === null || sentryConfig === void 0 ? void 0 : sentryConfig.errorMonitor)
        ...
        : undefined;
    var maybeErrorMonitor = (sentryConfig === null || sentryConfig === void 0 ? void 0 : sentryConfig.DSN) && !!(sentryConfig === null || sentryConfig === void 0 ? void 0 : sentryConfig.errorMonitor)
        ? bmModule._essentials.createErrorMonitor({
            dsn: sentryConfig.DSN,
            appName: process.env.ARTIFACT_ID,
            version: process.env.ARTIFACT_VERSION,
            user: {
                id: bmModule.moduleParams.userId,
            },
        })
        : undefined;
    ...
    if (maybeTranslationsModel) {
        ...
        var _g = createFetchAsyncMessagesLoader({
            localeDistPath: maybeTranslationsModel.localeDistPath,
            availableLocales: maybeTranslationsModel.availableLocales,
            errorReporter: maybeErrorReporterTransport,
        }), asyncMessagesLoader = _g.asyncMessagesLoader, addLocaleMessages = _g.addLocaleMessages;
        var i18n_1 = bmModule._essentials.createI18n({
            asyncMessagesLoader: asyncMessagesLoader,
            useSuspense: (_b = translationsConfig === null || translationsConfig === void 0 ? void 0 : translationsConfig.suspense) !== null && _b !== void 0 ? _b : true,
    ...
    return {
        ...
        maybeExperiments: ((_c = module.config.experiments) === null || _c === void 0 ? void 0 : _c.centralized) ? makeMutable(bmModule._essentials.experiments)
            : ((_e = (_d = module.config.experiments) === null || _d === void 0 ? void 0 : _d.scopes) === null || _e === void 0 ? void 0 : _e.length) ? bmModule._essentials.createExperiments({ scopes: [] })
                : undefined,
    };
}
