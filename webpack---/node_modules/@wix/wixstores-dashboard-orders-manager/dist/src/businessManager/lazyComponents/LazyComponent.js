...
var LazyComponent = /** @class */ (function (_super) {
    ...
    function LazyComponent(props) {
        ...
        var basicUrl = storeModule.topology.ordersStaticUrl;
        var debug = storeModule.getModuleParams().debug;
        var manifest = {
            files: [basicUrl + "registerOrdersComponent.bundle" + (debug ? '' : '.min') + ".js"],
            component: componentName_1.ComponentName.OrderPage,
            crossorigin: true,
        };
