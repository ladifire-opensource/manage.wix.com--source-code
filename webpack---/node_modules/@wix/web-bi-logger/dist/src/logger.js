...
var Factory = /** @class */ (function () {
    ...
    Factory.prototype.initFactory = function () {
        ...
        var options = __assign(__assign({}, this.options), { host: this.options.host || (function () { return env_1.getHost(common_config_1.getBrand(_this.commonConfigGetter)); }) });
        var publisher = publishers_1.getPublisher(options, this.publishFunctions);
        var _a = publishers_1.getTransformers(options, this.transformer), eventTransformer = _a.eventTransformer, payloadTransformer = _a.payloadTransformer;
    ...
    Factory.prototype.logger = function (options) {
        ...
        var logger = this.initFactory().logger(__assign({ endpoint: endpoint,
            useBatch: useBatch }, options));
        return logger;
    };
    return Factory;
}());
