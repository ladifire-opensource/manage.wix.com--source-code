...
function ReactLoadableComponent(name, resolve) {
  return function (_BaseLazyComponent) {
    _inherits(LoadableComponent, _BaseLazyComponent);

    function LoadableComponent(props) {
      _classCallCheck(this, LoadableComponent);

      var _this = _possibleConstructorReturn(this, (LoadableComponent.__proto__ || Object.getPrototypeOf(LoadableComponent)).call(this, props, { component: name, files: [], resolve: resolve }));
